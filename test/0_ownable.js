...
contract('OwnableModified', (accounts) => {
    ...
    before('should prepare', () => {
        console.log(`  ****** START TEST [ ${scriptName}]******* Accounts ${accounts.length}`);
    ...
    Object.keys(constructors).forEach((name) => {
        describe(name, () => {
            ...
            beforeEach(`should deploy a new ${name}`, async () => {
            ...
            describe('getOwners', () => {
                ...
                it('should not be possible to send a transaction with value to getOwners', () => owned.getOwners.sendTransaction({
                    from: owner1,
                    value: 1
                })
                    .then(
            ...
            describe('transferOwnership', () => {
                ...
                it('should not be possible to set owner if pass value', () => owned.transferOwnership(owner2, {
                    from: owner0,
                    value: 1
                })
                    .then(
